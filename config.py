...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6846535590:AAFpCephiMvbspCm4u1OeU1-xfTNFgRw4yE")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002025749324"))
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://hanimegod:hanimegod@hanimegod.qupcrgd.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "1425888381 6932416695").split()):
        ADMINS.append(int(x))
except ValueError:
